      ...
      <div className="flex flex-wrap flex-shrink-0">
          ...
          >
            <div className="flex items-center justify-center">
              ...
              <div className="ml-6 grow font-semibold text-lg sm:text-lg">
                <a className="text-black dark:text-black">+57-30026-22078</a>
              </div>
            </div>
          </a>
        </div>
        ...
        <div className="mb-12 w-full shrink-0 grow-0 basis-auto md:w-6/12 md:px-3 lg:px-6">
          ...
          >
            <div className="flex items-center justify-center">
              ...
              <div className="ml-6 grow font-semibold text-lg sm:text-lg">
                <p className="text-black dark:text-black">Mr. Frontend</p>
              </div>
            </div>
          </a>
        </div>
        ...
        <div className="mb-12 w-full shrink-0 grow-0 basis-auto md:w-6/12 md:px-3 lg:px-6">
          ...
          >
            <div className="align-start flex items-center justify-center">
              ...
              <div className="ml-6 grow font-semibold text-lg sm:text-lg ">
                <p className="text-black dark:text-black">Mr_Frontend_</p>
              </div>
            </div>
          </a>
        </div>
        ...
        <div className="mb-12 w-full shrink-0 grow-0 basis-auto md:w-6/12 md:px-3 lg:px-6">
          <div className="align-start flex items-center justify-center">
            ...
            <div className="w-full ml-6 grow font-semibold text-base ">
              <p className="text-black dark:text-black">info@mr-frontend.com</p>
            </div>
          </div>
        </div>
      </div>
