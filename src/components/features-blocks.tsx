      ...
      <div className="relative max-w-6xl mx-auto px-4 sm:px-6">
        <div className="py-12 md:py-20">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-20">
            <h2 className="text-4xl font-bold mb-4">Nuestro <span className='bg-clip-text text-transparent 
            bg-gradient-to-r from-fuchsia-600 to-teal-400'>trabajo</span></h2>
            <p className="text-xl text-gray-600">Innovacion y calidad en cada proyecto. Nuestro compromiso con la excelencia en el desarrollo web y nuestra pasion de superar tus expectativas.</p>
          </div>
          ...
          <div className="max-w-sm mx-auto grid gap-6 md:grid-cols-2 lg:grid-cols-3 items-start md:max-w-2xl lg:max-w-none">
            ...
            <div className="relative flex flex-col items-center p-6 bg-white rounded shadow-xl">
              ...
              <h3 className="text-xl text-center font-bold leading-snug tracking-tight mb-1">Soluciones completas para tu negocio</h3>
            ...
            <div className="relative flex flex-col items-center p-6 bg-white rounded shadow-xl">
              ...
              <h3 className="text-xl font-bold leading-snug tracking-tight mb-1">Soporte y mantenimiento</h3>
            ...
            <div className="relative flex flex-col items-center p-6 bg-white rounded shadow-xl">
              ...
              <h3 className="text-xl text-center font-bold leading-snug tracking-tight mb-1">Optimizacion de motores de busqueda</h3>
            ...
            <div className="relative flex flex-col items-center p-6 bg-white rounded shadow-xl">
              ...
              <h3 className="text-xl font-bold leading-snug text-center tracking-tight mb-1">Adaptabilidad a cualquier dispositivo</h3>
            ...
            <div className="relative flex flex-col items-center p-6 bg-white rounded shadow-xl">
              ...
              <h3 className="text-xl text-center font-bold leading-snug tracking-tight mb-1">Creando experiencias digitales unicas</h3>
            ...
            <div className="relative flex flex-col items-center p-6 bg-white rounded shadow-xl">
              ...
              <h3 className="text-xl font-bold leading-snug tracking-tight mb-1">Consultoria y Asesoramiento</h3>
